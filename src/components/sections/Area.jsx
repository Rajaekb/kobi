        ...
        <motion.div
            ...
            <div className='grid grid-cols-2 gap-7 max-w-5xl'>
                {technologies.map((item) => (
                    ...
                    <div className='flex flex-col   anim-box'>

                        <div className='flex gap-3 justify-between z-10 text-2xl text-white font-bold'>
                            <Image src={item.logoUrl} width={70} height={50} className='object-contain flex-start z-10' />
                            <h3 >{item.title}</h3> </div>
                        <p className='mx-5 z-10'>
                            {item.description}
                        </p>
                    </div>
                ))}
